...
//{
	...
	*/
	NX_C_EXPORT NXP_DLL_EXPORT bool NX_CALL_CONV NxRaySphereIntersect(const NxVec3& origin, const NxVec3& dir, const NxVec3& center, NxReal radius, NxVec3* coord=NULL);
//}
