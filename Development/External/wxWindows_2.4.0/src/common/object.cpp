...
// Modified by: Ron Lee
// Created:     04/01/98
// RCS-ID:      $Id: object.cpp,v 1.66 2002/08/13 22:37:41 VZ Exp $
...
// @hack @warning: VS.NET 2003 generates back code (not correctly initializing m_next to sm_first) if optimizations are
// enabled which leads to random classes not being registered.
#pragma optimize("", off) 
