...
public:
	...
	INT				CompileDynamicCast( const FToken& Token, FToken& ResultType );
	...
	UBOOL			GetVarType( UStruct* Scope, FPropertyBase& VarProperty, DWORD& ObjectFlags, QWORD Disallow, const TCHAR* Thing );
	...
	void			EmitStackNodeLinkFunction( UFunction* Node, UBOOL ForceFinal, UBOOL Global, UBOOL bSuper, UProperty *DelegateProp = NULL );
