...
*/
function bool OverridePickupQuery(Pawn Other, class<Inventory> ItemClass, out byte bAllowPickup)
{
	if ( (NextGameRules != None) &&  NextGameRules.OverridePickupQuery(Other, ItemClass, bAllowPickup) )
		return true;
	return false;
}
...
function NetDamage( int OriginalDamage, out int Damage, pawn injured, pawn instigatedBy, vector HitLocation, out vector Momentum, class<DamageType> DamageType )
{
	if ( NextGameRules != None )
